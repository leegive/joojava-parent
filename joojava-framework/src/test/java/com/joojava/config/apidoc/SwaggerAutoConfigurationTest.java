...
import com.joojava.config.apidoc.customizer.DefaultSwaggerCustomizer;
import com.joojava.config.apidoc.customizer.SwaggerCustomizer;
...
public class SwaggerAutoConfigurationTest {
    ...
    private FrameworkProperties.Swagger properties;
    ...
    public void testSwaggerSpringfoxApiDocket() {
        List<SwaggerCustomizer> customizers = Lists.newArrayList(new DefaultSwaggerCustomizer(properties));
